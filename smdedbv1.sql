...
CREATE TABLE IF NOT EXISTS `smdedbv1`.`Student_has_Subject` (
  ...
  `Subject_idSubject` VARCHAR(20) NOT NULL COMMENT '',
  PRIMARY KEY (`Student_idStudent`, `Subject_idSubject`)  COMMENT '',
  INDEX `fk_Student_has_Subject_Subject1_idx` (`Subject_idSubject` ASC)  COMMENT '',
  INDEX `fk_Student_has_Subject_Student1_idx` (`Student_idStudent` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `smdedbv1`.`Teacher_has_Subject` (
  ...
  `Subject_idSubject` VARCHAR(20) NOT NULL COMMENT '',
  PRIMARY KEY (`Teacher_idTeacher`, `Subject_idSubject`)  COMMENT '',
  INDEX `fk_Teacher_has_Subject_Subject1_idx` (`Subject_idSubject` ASC)  COMMENT '',
  INDEX `fk_Teacher_has_Subject_Teacher1_idx` (`Teacher_idTeacher` ASC)  COMMENT '',
