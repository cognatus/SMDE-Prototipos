...
CREATE TABLE IF NOT EXISTS `smdedbv1`.`Message` (
  ...
  `Lobby_idLobby` VARCHAR(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `smdedbv1`.`Publication` (
  ...
  `Group_idGroup` VARCHAR(20) NOT NULL,
  `Teacher_User_userEmail` VARCHAR(100) NOT NULL,
  PRIMARY KEY (`idPublication`, `Teacher_User_userEmail`),
  INDEX `fk_Publication_Group1_idx` (`Group_idGroup` ASC),
  INDEX `fk_Publication_Teacher1_idx` (`Teacher_User_userEmail` ASC),
...
CREATE TABLE IF NOT EXISTS `smdedbv1`.`Feedback` (
  ...
  `Publication_idPublication` VARCHAR(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `smdedbv1`.`ForumTopic` (
  `idForumTopic` VARCHAR(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `smdedbv1`.`Note` (
  ...
  PRIMARY KEY (`Student_User_userEmail`),
  INDEX `fk_Note_Student1_idx` (`Student_User_userEmail` ASC),
...
CREATE TABLE IF NOT EXISTS `smdedbv1`.`Reminder` (
  `idReminder` VARCHAR(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `smdedbv1`.`ForumComent` (
  `idForumComent` VARCHAR(20) NOT NULL,
  `forumText` MEDIUMTEXT NULL,
  `User_userEmail` VARCHAR(100) NOT NULL,
  `ForumTopic_idForumTopic` VARCHAR(20) NOT NULL,
  PRIMARY KEY (`idForumComent`, `User_userEmail`, `ForumTopic_idForumTopic`),
...
CREATE TABLE IF NOT EXISTS `smdedbv1`.`Administrator` (
  `idAdministrator` VARCHAR(20) NOT NULL,
  `User_userEmail` VARCHAR(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `smdedbv1`.`Notification` (
  `idNotification` VARCHAR(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `smdedbv1`.`User_has_Notification` (
  `User_userEmail` VARCHAR(100) NOT NULL,
  `Notification_idNotification` VARCHAR(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `smdedbv1`.`Subject` (
  ...
  PRIMARY KEY (`idSubject`, `Department_Institute_idInstitute`, `Department_idDepartment`),
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `smdedbv1`.`Group_has_Subject` ;
...
-- -----------------------------------------------------
-- Table `smdedbv1`.`Student_has_Subject`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `smdedbv1`.`Student_has_Subject` ;

CREATE TABLE IF NOT EXISTS `smdedbv1`.`Student_has_Subject` (
  `Student_idStudent` VARCHAR(20) NOT NULL,
  `Subject_idSubject` VARCHAR(20) NOT NULL,
...
-- -----------------------------------------------------
-- Table `smdedbv1`.`Teacher_has_Subject`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `smdedbv1`.`Teacher_has_Subject` ;

CREATE TABLE IF NOT EXISTS `smdedbv1`.`Teacher_has_Subject` (
  `Teacher_idTeacher` VARCHAR(20) NOT NULL,
  `Subject_idSubject` VARCHAR(20) NOT NULL,
  PRIMARY KEY (`Teacher_idTeacher`, `Subject_idSubject`),
  INDEX `fk_Teacher_has_Subject_Subject1_idx` (`Subject_idSubject` ASC),
  INDEX `fk_Teacher_has_Subject_Teacher1_idx` (`Teacher_idTeacher` ASC),
