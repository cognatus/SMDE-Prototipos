...
CREATE TABLE IF NOT EXISTS `smdedbv1`.`User` (
  ...
  PRIMARY KEY (`userEmail`, `Institute_idInstitute`),
...
CREATE TABLE IF NOT EXISTS `smdedbv1`.`Publication` (
  ...
  `publicationLimitDate` DATETIME NULL,
  `Teacher_User_userEmail` VARCHAR(100) NOT NULL,
  `Subject_has_Course_Subject_idSubject` VARCHAR(20) NOT NULL,
  `Subject_has_Course_Course_idCourse` VARCHAR(20) NOT NULL,
