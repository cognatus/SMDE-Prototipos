    ...
    jQuery.ajax({
        ...
        success: function(data) {
            for(var i in data){
                ...
                +     '<div data-rippleria="" class="colhh1 hover listitem_cal rippleria-dark">'
                +         '<div class="listitem_img">'
                +             '<span class="bg_cyan">A</span>'
                +         '</div>'
                ...
                +                     '<div class="pd_16 justify_text breakword">' + item.pubText + '</div>'
                +                     '<div class="attached_filecontainer autooverflow">'
                ...
                +                 '</div>'
                +             '</div>'
                +             '<div class="pd_24 listitemactions autooverflow">'
